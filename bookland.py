...
z = sys.version_info
PYTHONVERSION = '%d.%d.%d' % (z.major, z.minor, z.micro)
...
def rgbtocmyk(rgb):
    'rgb to cmyk, (floating point representations)'
    # Some hold such formulas to be fundamentally wrong.
    # This is just a convenience for user.
    # If color precision important, best consult with printer.
